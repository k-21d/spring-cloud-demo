...
@WebServlet(name = "ribbonGateway", urlPatterns = "/ribbonGateway/*")
public class RibbonGatewayServlet extends HttpServlet {

    @Autowired
    private ZookeeperLoadBanancer zookeeperLoadBanancer;
    private Server chooseServer(Server serviceName){
        Server server = zookeeperLoadBanancer.chooseServer(serviceName);
        return server;
    }
    ...
    public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Server serviceInstance = chooseServer(new Server(serviceName));
        //构建目标服务的URL
